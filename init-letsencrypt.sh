...
domains=(dragdrop.website www.dragdrop.website gapi.brocorp.site napi.brocorp.site papi.brocorp.site mapi.brocorp.site)

rsa_key_size=4096
data_path="./data/certbot"

email="lokesh.poovaragan@gmail.com" # Adding a valid address is strongly recommended, please add your own email !
